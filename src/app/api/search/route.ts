...
import { JikanMangaDto, JikanPagedResult } from "./jikan.types";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const JIKAN_API_URL = `https://api.jikan.moe/v4/manga?order_by=popularity&sort=asc&limit=5&q=${encodeURIComponent(query)}&limit=15`;
