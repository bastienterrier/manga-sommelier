  ...
  return (
    <div>
      ...
      <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        <div className="manga-card cursor-pointer group">
          <img
            src="https://placehold.co/300x450/1f2937/ffffff?text=Berserk"
        ...
        <div className="manga-card cursor-pointer group">
          <img
            src="https://placehold.co/300x450/1f2937/ffffff?text=One-Punch+Man"
            alt="Couverture de One-Punch Man"
            className="rounded-lg w-full aspect-[2/3] object-cover shadow-lg"
          />
          <p className="text-center mt-2 font-medium text-sm truncate group-hover:text-indigo-300">
            One-Punch Man
        ...
        <div className="manga-card cursor-pointer group">
          <img
            src="https://placehold.co/300x450/1f2937/ffffff?text=Vinland+Saga"
            alt="Couverture de Vinland Saga"
            className="rounded-lg w-full aspect-[2/3] object-cover shadow-lg"
          />
          <p className="text-center mt-2 font-medium text-sm truncate group-hover:text-indigo-300">
            Vinland Saga
        ...
        <div className="manga-card cursor-pointer group">
          <img
            src="https://placehold.co/300x450/1f2937/ffffff?text=Kingdom"
            alt="Couverture de Kingdom"
            className="rounded-lg w-full aspect-[2/3] object-cover shadow-lg"
          />
          <p className="text-center mt-2 font-medium text-sm truncate group-hover:text-indigo-300">
            Kingdom
